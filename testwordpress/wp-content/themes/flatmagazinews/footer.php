	...
	<div class="content-wrap">
		...
		<div class="site-info">
			...
			<span class="footer-info-right">
				<?php echo __(' | WordPress Theme by', 'flatmagazinews') ?> <a rel="nofollow" href="<?php echo esc_url('https://superbthemes.com/', 'flatmagazinews'); ?>"><?php echo __('Superbthemes.com', 'flatmagazinews') ?></a>
			</span>
